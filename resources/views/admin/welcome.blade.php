                                ...
                                <div class="d-flex justify-content-between align-items-baseline">
                                    ...
                                    <div class="dropdown mb-2">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item d-flex align-items-center" href="#"><i data-feather="trash" class="icon-sm me-2"></i> <span class="">Delete</span></a>
                                            <a class="dropdown-item d-flex align-items-center" href="#"><i data-feather="printer" class="icon-sm me-2"></i> <span class="">Print</span></a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <a href="#" class="d-flex align-items-center border-bottom py-3">
                                ...
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="text-body mb-2">Bill Gichuru</h6>
                            ...
                            <a href="#" class="d-flex align-items-center border-bottom py-3">
                                ...
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="text-body mb-2">John Doe</h6>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom">EmberJs</td>
