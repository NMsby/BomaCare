...
@section('admin-content')
    ...
    <div class="page-content" id="page">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <a href="#page" class="me-4 btn btn-inverse-success">Add Role</a>
        ...
        <div class="row profile-body mb-4">
            <div class="col-md-8 col-xl-8 middle-wrapper">
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4 text-center">Add Role</h4>
                            <form class="forms-sample" method="post" action="{{ route('roles.store') }}">
                                ...
                                <button type="submit" class="btn btn-inverse-success mr-2">Add Role</button>
